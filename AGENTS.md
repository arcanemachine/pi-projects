...
- If an extension action is explicitly user-driven, expose it through a user command rather than an agent-callable tool; do not rely on tool-call provenance checks to enforce that boundary.
