...
- [pi-consult](https://github.com/arcanemachine/pi-consult) - Run configurable, isolated, text-only multi-model consultation workflows with staged fan-out and synthesis.
